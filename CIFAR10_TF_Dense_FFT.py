...
# Parameters
learning_rate = 0.001
training_epochs = 250    # best results 250
batch_size = 10000
display_step = 1
...
with tf.Session() as sess:
    ...
    y_pred_hot = np_utils.to_categorical(y_pred)  # one hot encoding [B FCC] => [0 1].
    fpr, tpr, roc_auc = generate_ROC(y_test,y_pred_hot,n_classes)

    # generate multiclass ROC curves
    generate_multiclass_ROC(fpr,tpr,roc_auc,n_classes)
